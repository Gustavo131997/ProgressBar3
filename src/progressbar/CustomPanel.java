...
public class CustomPanel extends JPanel{
    ...
    public void paint(Graphics g){
        ...
        arc.setFrameFromCenter(new Point(0,0), new Point(120,120));//ajusta el tamaño del circulo rojo
        circle.setFrameFromCenter(new Point(0,0), new Point(100,100));//ajusta el tamaño del circulo blanco
        arc.setAngleStart(1);
        arc.setAngleExtent(-this.progress*3.6); // 360/100
        ...
        Rectangle2D rec = fm.getStringBounds(progress+"%", g);
